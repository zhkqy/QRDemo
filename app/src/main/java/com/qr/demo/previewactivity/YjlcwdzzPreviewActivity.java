...
public class YjlcwdzzPreviewActivity extends BasePreviewActivity {
    ...
    protected void initData() {
        ...
        String discrep = "　　" + printModel.year + "年" + printModel.month + "月" + printModel.day + "日，" + printModel.trainNum + "次列车到达" +
                printModel.troubleStation + "站时晚点" + printModel.lateMinute + ",旅客" + printModel.name + ",身份证号码" + printModel.cardNum + "," +
                "持一张" + printModel.beginStation + "站至" + printModel.stopStation + "站车票," + printModel.chexiang + "，" +
                ...
                printModel.zhongzChexiang + "席（铺）位，票号" + printModel.zhongzTicketNum + "，现移交你站，请按章办理。";
