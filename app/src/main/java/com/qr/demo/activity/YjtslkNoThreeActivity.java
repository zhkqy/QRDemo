...
import com.qr.demo.previewactivity.YjtslkPreviewNoThreeActivity;
 ...
 * 移交烫伤旅客(无第三者责任)
 */
public class YjtslkNoThreeActivity extends NewBaseCommonActivity implements ContractNewCommonAdapter.CommonListener {
    ...
    public void onclick(final int position, CommonModel model) {
        ...
        if (model.getRequestCode() == 1101) {
            ...
            Intent mIntent = new Intent(this, YjtslkPreviewNoThreeActivity.class);
            ...
            carriageAndSeatDialog.setListener(new CarriageAndSeatDialog.Listener() {
                ...
                public void onItemClicked(String carriageNum, String seatNum) {
                    ...
                    YjtslkNoThreeActivity.this.carriageNum = carriageNum;
                    YjtslkNoThreeActivity.this.seatNum = seatNum;
            ...
            carriageAndSeatDialog.setListener(new CarriageAndSeatDialog.Listener() {
                ...
                public void onItemClicked(String carriageNum, String seatNum) {
                    ...
                    YjtslkNoThreeActivity.this.otherCarriageNum = carriageNum;
                    YjtslkNoThreeActivity.this.otherSeatNum = seatNum;
