...
import com.qr.demo.previewactivity.YjwcPreviewActivity;
 ...
 * 移交误乘旅客
 */
public class YjwcActivity extends NewBaseCommonActivity implements ContractNewCommonAdapter.CommonListener {
    ...
    protected void initData() {
        ...
        models.add(new CommonModel(
                new CommonTextEditTextModel("原票车次", "", "请输入原票车次")));

        models.add(new CommonModel(
                new CommonTextEditTextModel("原票发站", "", "请输入原票发站")));
        models.add(new CommonModel(
                new CommonTextEditTextModel("原票到站", "", "请输入原票到站")));
        models.add(new CommonModel(
